...
?>
						...
						<div class="previous-image"><?php previous_image_link( '%link', __( '&larr; Previous Image', 'tatami' )); ?></div>
						<div class="next-image"><?php next_image_link(  '%link', __( 'Next Image &rarr;', 'tatami' ) ); ?></div>
